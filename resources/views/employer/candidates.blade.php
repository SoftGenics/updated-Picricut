            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">Candidates</h1> 
                    </div>
                    <div class="
                col-lg-4 col-md-6
                d-none d-md-flex
...
<div class="row">
                  ...
                  <div class="card text-center">
                    <div class="card-body">
                      ...
                      <div class="mt-n2">
                        ...
                        <h4 class="mt-3"> employee title</h4>
                        <h6 class="card-subtitle">speciality</h6>
                      </div>
                ...
                <div class="col-lg-4">
                  <div class="card text-center">
                    <div class="card-body">
                      <img src="https://demos.wrappixel.com/premium-admin-templates/bootstrap/flexy-bootstrap/package/assets/images/users/2.jpg" class="rounded-3 img-fluid" width="90">
                      <div class="mt-n2">
                ...
                <div class="col-lg-4">
                  <div class="card text-center">
                    <div class="card-body">
                      <img src="https://demos.wrappixel.com/premium-admin-templates/bootstrap/flexy-bootstrap/package/assets/images/users/4.jpg" class="rounded-3 img-fluid" width="90">
                      <div class="mt-n2">
