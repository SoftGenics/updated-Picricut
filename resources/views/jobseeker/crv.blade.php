                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">Company rating and reviews</li>
                            </ol>
                          </nav>
                        <h1 class="mb-0 fw-bold">Company rating and reviews</h1> 
                    </div>
                    <div class="
                col-lg-4 col-md-6
                d-none d-md-flex
                    ...
                    <div class="col-md-4 col-xl-6 d-flex align-items-stretch">
                        <a href="javascript:void(0)" class="card bg-primary text-white w-100 card-hover">
                          <div class="card-body">
                            ...
                            <div class="mt-4">
                              <h4 class="card-title mb-1 text-white">Company name</h4>
